...
class ArgContainer:
    def __init__(self):
        ...
        self.WaveEquation2D_Long = SolverArg(layer_size=[3, 20, 20, 20, 1], neuron_type='tanh', grid_num=[8] * 3, coef=[0.1] * 3, Q=10, test_fcn_num=5, epoch_num=10000, model_name='WaveEquation2D_Long', layers=[0, 1, 2, 3])
